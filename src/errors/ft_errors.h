...
# define ERRMSG_MALLOC "Error: malloc failed\n"
# define ERRMSG_MLX_INIT "Error: failed to initialize MLX\n"
# define ERRMSG_MLX_NEW_IMG "Error: failed to create new image\n"
# define ERRMSG_MLX_IMAGE_TO_WINDOW "Error: failed to put image to window\n"
